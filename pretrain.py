...
def train(trainset, validset, testset, run_tag, hp):
    ...
    Args:
        trainset (PretrainDataset): the training set
        validset (PretrainDataset): the validation set
        testset (PretrainDataset): the test set
    ...
    model = PretrainModel(device=device,
                       lm=hp.lm,
